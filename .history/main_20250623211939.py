...
from comandos.warn import DesWarnMiembro, CheckWarnsMiembro, modal_warn
...
from comandos.SPOTIFY.spotify import check_if_user_is_logged_for_spotify
import sqlite3
...
@client.tree.command(name='loguear_con_spotify', description='Logueate con sopotify', guild=GUILD_ID)
async def loguear_con_spotify(interaction: discord.Interaction, username: discord.User):
    await check_if_user_is_logged_for_spotify(interaction, username)
