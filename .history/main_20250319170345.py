...
@client.tree.command(name='mirar_tracker', description='Mira el tracker de un jugador de Valorant', guild=GUILD_ID)
async def mirar_tracker(interaction: discord.Interaction, nombre: str, tag: str):
    try:
        await MirarTracker(interaction, nombre, tag)
    except Exception as e:
        print(f"Error en mirar_tracker: {e}")
